        ...
        stage('terraform init/plan') {
            steps {
                script{
                     ...
                     sh """
                        ls -lrth
                        cd my_learnings/my_codes/my_4terraform_code/My_vm3+lb
                        /var/jenkins_home/workspace/my_terraform_pipeline_3/tf_binary/terraform init
                        /var/jenkins_home/workspace/my_terraform_pipeline_3/tf_binary/terraform  plan 
                     """
                }
        ...
        stage('terraform apply') {
            steps {
                script{
                     ...
                     sh """
                        cd my_learnings/my_codes/my_4terraform_code/My_vm3+lb
                        /var/jenkins_home/workspace/my_terraform_pipeline_3/tf_binary/terraform apply -auto-approve
                     """
                }
